...
$blogger_name_4          = get_field('blogger_name_4');
$blogger_title_4         = get_field('blogger_title_4');
$blogger_image_4         = get_field('blogger_image_4');
?>
   			...
   			<div class="row">
   				<div class="col-md-12">
                     ...
                     <div class="col-md-3">
                        ...
                        <ul class="team-social">
                           <?php if( !empty($twitter_username_3) ): ?>
                     ...
                     <div class="col-md-3">
                        <div class="team-max">
                        <div class="staff-thumb">
                           <?php if( !empty($blogger_image_4) ): ?>
                              <img src="<?php echo $blogger_image_4['url']; ?>" alt="<?php echo $blogger_image_4['alt']; ?>" class="img-responsive">
                           <?php endif; ?>
                           <span><a href="#"><i class="fa fa-plus"></i></a></span>
                        </div>
                        <h4><?php echo $blogger_name_4; ?><span><?php echo $blogger_title_4; ?></span></h4>
                        <!--<ul class="team-social">
                           <?php if( !empty($twitter_username_2) ): ?>
                           <a href="https://twitter.com/<?php echo $twitter_username_3; ?>" class="badge social twitter" target="_blank"><i class="fa fa-twitter"></i></a>
                           <?php endif; ?>
